const SubmissionCard = ({ submission }) => {
  ...
  return (
    <div
      id="subCard"
      className="h-72 xl:w-96 w-full shadow-customDark2 px-4 dark:bg-myblack2 rounded-md flex flex-col justify-evenly hover:scale-105 hover:scale-105 cursor-pointer transform transition-transform duration-300 ease-in-out"
    >
